...
import { createFeedback, generateQuestion, getRandomTopic, readPdf ,getLeetCodeAnalysis,analyzeGitHubRepo} from '../controller/ai.controller.js';
...
router.post('/analyzeGitHubRepo',protectRoute,analyzeGitHubRepo)
