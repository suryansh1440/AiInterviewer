        ...
        <div className="w-full max-w-5xl bg-base-100 rounded-3xl shadow-2xl p-8 md:p-12 transition-shadow duration-200 hover:shadow-[0_0_40px_10px_var(--tw-shadow-color,theme(colors.primary/0.15))]">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-base-200/80 rounded-xl p-6 text-center shadow-md hover:shadow-lg hover:scale-105 transition-transform duration-200">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="flex flex-col items-center">
                <span className="w-12 h-12 flex items-center justify-center rounded-full bg-primary text-primary-content font-bold text-xl mb-2 shadow-md">1</span>
              ...
              <div className="flex flex-col items-center">
                <span className="w-12 h-12 flex items-center justify-center rounded-full bg-primary text-primary-content font-bold text-xl mb-2 shadow-md">2</span>
              ...
              <div className="flex flex-col items-center">
                <span className="w-12 h-12 flex items-center justify-center rounded-full bg-primary text-primary-content font-bold text-xl mb-2 shadow-md">3</span>
              ...
              <div className="flex flex-col items-center">
                <span className="w-12 h-12 flex items-center justify-center rounded-full bg-primary text-primary-content font-bold text-xl mb-2 shadow-md">4</span>
