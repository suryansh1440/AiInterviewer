      ...
      <ul className="nav-links flex items-center gap-6 text-gray-700 font-medium">
        ...
        {isSignedIn ? (
          <li className="relative account-dropdown">
            <button
              id="accountBtn"
              className="flex items-center gap-1 px-4 py-2 rounded-md hover:bg-gray-100 transition-colors duration-200 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-200"
