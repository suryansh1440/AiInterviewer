...
const Footer = () => {
  return (
    <footer className="w-full bg-base-300 text-base-content py-8 px-4 mt-12">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
        ...
        <div className="flex flex-col items-center md:items-start gap-3 max-w-xs">
          <div className="flex items-center gap-2 text-2xl font-bold select-none">
            <span className="text-base-content">AI Interview</span>
            <span className="text-primary text-3xl">.</span>
          </div>
          <p className="text-base-content/70 text-sm mt-1 text-center md:text-left">
        ...
        <div className="flex flex-col items-center gap-2 w-full max-w-sm">
          <span className="font-semibold text-base-content mb-1">Subscribe to our newsletter</span>
          <form className="flex w-full max-w-xs">
            <input
              type="email"
              className="flex-1 px-3 py-2 rounded-l-md bg-base-200 text-base-content border border-base-300 focus:outline-none focus:ring-2 focus:ring-primary"
              placeholder="Your email address"
              disabled
            />
            <button
              type="submit"
              className="px-4 py-2 rounded-r-md bg-primary text-primary-content font-semibold hover:bg-primary-focus transition-colors duration-200 cursor-not-allowed"
              disabled
            >
              Subscribe
            </button>
          </form>
          <span className="text-xs text-base-content/50">(Demo only)</span>
        </div>
        {/* Copyright & Socials */}
        <div className="flex flex-col items-center md:items-end gap-2">
          ...
          <span className="text-xs text-base-content/50">&copy; {new Date().getFullYear()} AI Interview. All rights reserved.</span>
        </div>
      </div>
    </footer>
  );
